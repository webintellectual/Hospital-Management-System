...
#----------------------------------------------------Buttons-----------------------------
        ...
        self.loginbutton = Button(self,image=self.photo,borderwidth=0,highlightthickness=0,command=lambda: file_manager.authenticate(self,username_entry.get(),passwrd_entry.get(),'employee'))
