...
class pat_Profile_update(tk.Toplevel):
    def __init__(self,username,password, master=None):
        ...
        self.title("PATIENT-PROFILE (UPDATE) (patient_profile_update.py)")

        self.canvas = tk.Canvas(self, width=window_width, height=window_height)
        self.canvas.pack(fill=tk.BOTH, expand=True)

        image = Image.open('Images/patient_main_profile_edit.png')
...
#-------------------------------------------------------------- Entry box / button ---------------------------------------------------------------
        ...
        blood_grp_entry.place(width=409,height=36,x=553,y=114+((36+gap)*6))
...
#-----------------------------------------------------------function define -----------------------------------------------------------------
    ...
    #                 row['email'] = email
    #                 row['phone'] = phone
    #                 row['blood_grp'] = blood_grp
    #                 row['password'] = password
    #             data.append(row)

    #     with open('database/pat_details.csv', 'w', newline='') as csv_file:
    ...
    def save_details(self):
        self.file_manager.update_profile(self, 'patient')
...
#     app = pat_Profile_update("Demo123","Demo123")
#     app.mainloop()